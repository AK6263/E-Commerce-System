...
int printcart(){
    ...
    gotoxy(0,10);
                ...
                {
                printf("\n%-5d|%-20s|%-50s|%8.2f|%4d", a.id, a.name, a.price, a.quantity);
                }*/

                while(fscanf(fp, "%d %s %d %f %*s", &a.id, a.name, &a.quantity, &a.price)==4)
                {
                printf("\t%-10d\t %-12s\t\t %8d\t %8.2f\t %-12s\n\n", a.id, a.name, a.quantity, a.price);
                }
...
int displayProduct() {
    ...
    gotoxy(5, 7);
    printf("Product ID\t\t Product Name\t\t Quantity\tPrice\t Description\n"); //TABLE TITLES !
    ...
    gotoxy(5,10);
                while (fread(&a,sizeof(Product), 1,fp))
                {
                printf("\n%-5d\t\t%-20s\t\t%4d\t%8.2f\t%-50s", a.id, a.name,a.quantity, a.price, a.description);
                }
                /*
                fread(&a,sizeof(Product),1,fp);
                printf("\n%-5d|%-20s|%-50s|%8.2f|%4d", a.id, a.name, a.description, a.price, a.quantity);
                */

                /*
                while(fscanf(fp, "%d %s %d %f %s", &a.id, a.name, &a.quantity, &a.price)==4)
                {
                printf("\t%-10d\t %-12s\t\t %8d\t %8.2f %-12s\n\n", a.id, a.name, a.quantity, a.price, a.description);
                }
                */
